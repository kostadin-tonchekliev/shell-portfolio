        ...
        <header className="py-6 sm:py-8 md:py-10 px-4 sm:px-6 md:px-8 border-b border-bg-tertiary/50 backdrop-blur-sm bg-bg-secondary/30">
          <div className="max-w-[1800px] mx-auto flex flex-col md:flex-row items-center gap-4 sm:gap-6 md:gap-8">
            ...
            <div className="relative flex-shrink-0">
              ...
              <div className="absolute -bottom-1 -right-1 w-5 h-5 sm:w-6 sm:h-6 bg-prompt-green rounded-full border-2 border-bg-secondary" title="Available" />
            </div>
            ...
            <div className="text-center md:text-left flex-1 min-w-0">
              ...
              <p className="text-text-primary text-base sm:text-lg mb-0.5 sm:mb-1 truncate">{profile.title}</p>
              <p className="text-text-secondary text-sm sm:text-base line-clamp-2 sm:line-clamp-none">{profile.tagline}</p>
            </div>
            ...
            <div className="flex gap-3 sm:gap-4 flex-shrink-0">
              ...
              {profile.links.github && (
                <a
                  ...
                  className="w-9 h-9 sm:w-10 sm:h-10 rounded-lg bg-bg-tertiary/50 border border-bg-tertiary hover:border-accent hover:bg-accent/10 transition-all duration-200 flex items-center justify-center text-text-secondary hover:text-accent"
                  title="GitHub"
                >
